...
import { Tabs as FumiTabs, Tab } from 'fumadocs-ui/components/tabs'
import { RunDemo } from '@/components/ui/run-demo'
import TabBarDemo, { TabBarSimpleDemo } from '@/components/demos/tab-bar-demo'
...
<FumiTabs items={['bun', 'npm', 'yarn', 'pnpm']}>
<Tab value="bun">
```bash title="Terminal"
bun add @gridland/ui
```
...
import { Tabs, TabsList, TabsTrigger, TabsContent } from "@gridland/ui"
